...
type
    ...
    # Global
    QWizard_WizardButton* {.header:headerFile,importcpp:"QWizard::WizardButton".} = enum BackButton = 0, NextButton = 0x1, CommitButton = 0x2, FinishButton = 0x3, 
        CancelButton = 0x4, HelpButton = 0x5, CustomButton1 = 0x6, CustomButton2 = 0x7, CustomButton3 = 0x8, 
        Stretch = 0x9, NoButton = 0xa, NStandardButtons = 0xb, NButtons = 0xc
    ...
    QWizard_WizardStyle* {.header:headerFile,importcpp:"QWizard::WizardStyle".} = enum ClassicStyle = 0, ModernStyle = 0x1, MacStyle = 0x2, AeroStyle = 0x3, 
        NStyles = 0x4
    QWizard_WizardOption* {.header:headerFile,importcpp:"QWizard::WizardOption".} = enum IndependentPages = 0, IgnoreSubTitles = 0x1, ExtendedWatermarkPixmap = 0x2, NoDefaultButton = 0x3, 
        NoBackButtonOnStartPage = 0x4, NoBackButtonOnLastPage = 0x5, DisabledBackButtonOnLastPage = 0x6, HaveNextButtonOnLastPage = 0x7, HaveFinishButtonOnEarlyPages = 0x8, 
        NoCancelButton = 0x9, CancelButtonOnLeft = 0xa, HaveHelpButton = 0xb, HelpButtonOnRight = 0xc, HaveCustomButton1 = 0xd, 
        HaveCustomButton2 = 0xe, HaveCustomButton3 = 0xf, NoCancelButtonOnLastPage = 0x10
