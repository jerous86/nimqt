...
# 1 default parameters!
proc split*(this: QString, sep: QString, behavior: Qt_SplitBehavior, cs: Qt_CaseSensitivity): QStringList {.header:headerFile, importcpp:"#.split(@)".} # Public
proc split*(this: QString, sep: QString, behavior: Qt_SplitBehavior): QStringList {.header:headerFile, importcpp:"#.split(@)".} # Public
