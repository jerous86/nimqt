...
when (NimMajor, NimMinor, NimPatch) < (1, 9, 0):
    type
        ...
        QPixmapCache* {.header:headerFile,importcpp:"QPixmapCache" ,pure.} = object {.inheritable.}
        QPixmapCache_Key* {.header:headerFile,importcpp:"QPixmapCache::Key" ,pure.} = object {.inheritable.}
