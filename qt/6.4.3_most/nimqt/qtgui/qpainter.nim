...
proc newQPainter*():QPainter {. header:headerFile, importcpp:"QPainter(@)" .} #
import nimqt/qtgui/qpaintdevice
proc newQPainter*(arg_0: ptr QPaintDevice): QPainter {. header:headerFile, importcpp:"QPainter(@)" .} #
...
proc drawPoints*(this:QPainter, points:QPointF, pointCount: cint) {.header:headerFile, importcpp:"#.drawPoints(@)".} # Public
import nimqt/qtgui/qpolygon
proc drawPoints*(this:QPainter, points: QPolygonF) {.header:headerFile, importcpp:"#.drawPoints(@)".} # Public
proc drawPoints*(this:QPainter, points:QPoint, pointCount: cint) {.header:headerFile, importcpp:"#.drawPoints(@)".} # Public
...
proc drawLines*(this:QPainter, lines:QLineF, lineCount: cint) {.header:headerFile, importcpp:"#.drawLines(@)".} # Public
import nimqt/qtcore/qlist
proc drawLines*(this:QPainter, lines: QList[QLineF]) {.header:headerFile, importcpp:"#.drawLines(@)".} # Public
proc drawLines*(this:QPainter, pointPairs:QPointF, lineCount: cint) {.header:headerFile, importcpp:"#.drawLines(@)".} # Public
proc drawLines*(this:QPainter, pointPairs: QList[QPointF]) {.header:headerFile, importcpp:"#.drawLines(@)".} # Public
proc drawLines*(this:QPainter, lines:QLine, lineCount: cint) {.header:headerFile, importcpp:"#.drawLines(@)".} # Public
proc drawLines*(this:QPainter, lines: QList[QLine]) {.header:headerFile, importcpp:"#.drawLines(@)".} # Public
proc drawLines*(this:QPainter, pointPairs:QPoint, lineCount: cint) {.header:headerFile, importcpp:"#.drawLines(@)".} # Public
...
proc drawRects*(this:QPainter, rects:QRectF, rectCount: cint) {.header:headerFile, importcpp:"#.drawRects(@)".} # Public
proc drawRects*(this:QPainter, rectangles: QList[QRectF]) {.header:headerFile, importcpp:"#.drawRects(@)".} # Public
proc drawRects*(this:QPainter, rects:QRect, rectCount: cint) {.header:headerFile, importcpp:"#.drawRects(@)".} # Public
...
proc drawPolyline*(this:QPainter, points:QPointF, pointCount: cint) {.header:headerFile, importcpp:"#.drawPolyline(@)".} # Public
proc drawPolyline*(this:QPainter, polyline: QPolygonF) {.header:headerFile, importcpp:"#.drawPolyline(@)".} # Public
proc drawPolyline*(this:QPainter, points:QPoint, pointCount: cint) {.header:headerFile, importcpp:"#.drawPolyline(@)".} # Public
proc drawPolyline*(this:QPainter, polygon: QPolygon) {.header:headerFile, importcpp:"#.drawPolyline(@)".} # Public
proc drawPolygon*(this:QPainter, points:QPointF, pointCount: cint, fillRule: Qt_FillRule) {.header:headerFile, importcpp:"#.drawPolygon(@)".} # Public
proc drawPolygon*(this:QPainter, polygon: QPolygonF, fillRule: Qt_FillRule) {.header:headerFile, importcpp:"#.drawPolygon(@)".} # Public
proc drawPolygon*(this:QPainter, points:QPoint, pointCount: cint, fillRule: Qt_FillRule) {.header:headerFile, importcpp:"#.drawPolygon(@)".} # Public
proc drawPolygon*(this:QPainter, polygon: QPolygon, fillRule: Qt_FillRule) {.header:headerFile, importcpp:"#.drawPolygon(@)".} # Public
proc drawConvexPolygon*(this:QPainter, points:QPointF, pointCount: cint) {.header:headerFile, importcpp:"#.drawConvexPolygon(@)".} # Public
proc drawConvexPolygon*(this:QPainter, polygon: QPolygonF) {.header:headerFile, importcpp:"#.drawConvexPolygon(@)".} # Public
proc drawConvexPolygon*(this:QPainter, points:QPoint, pointCount: cint) {.header:headerFile, importcpp:"#.drawConvexPolygon(@)".} # Public
...
# 1 default parameters!
proc drawPixmapFragments*(this:QPainter, fragments:QPainter_PixmapFragment, fragmentCount: cint, pixmap: QPixmap, hints: QFlags[QPainter_PixmapFragmentHint]) {.header:headerFile, importcpp:"#.drawPixmapFragments(@)".} # Public
proc drawPixmapFragments*(this:QPainter, fragments:QPainter_PixmapFragment, fragmentCount: cint, pixmap: QPixmap) {.header:headerFile, importcpp:"#.drawPixmapFragments(@)".} # Public
...
# 1 default parameters!
proc drawText*(this:QPainter, r: QRectF, flags: cint, text: QString, br:QRectF) {.header:headerFile, importcpp:"#.drawText(@)".} # Public
proc drawText*(this:QPainter, r: QRectF, flags: cint, text: QString) {.header:headerFile, importcpp:"#.drawText(@)".} # Public
# 1 default parameters!
proc drawText*(this:QPainter, r: QRect, flags: cint, text: QString, br:QRect) {.header:headerFile, importcpp:"#.drawText(@)".} # Public
proc drawText*(this:QPainter, r: QRect, flags: cint, text: QString) {.header:headerFile, importcpp:"#.drawText(@)".} # Public
# 1 default parameters!
proc drawText*(this:QPainter, x: cint, y: cint, w: cint, h: cint, flags: cint, text: QString, br:QRect) {.header:headerFile, importcpp:"#.drawText(@)".} # Public
...
proc paintEngine*(this:QPainter):QPaintEngine {.header:headerFile, importcpp:"#.paintEngine(@)".} # Public
