...
when (NimMajor, NimMinor, NimPatch) < (1, 9, 0):
    ...
    type
        ...
        QTextFrameLayoutData* {.header:headerFile,importcpp:"QTextFrameLayoutData" ,pure.} = object {.inheritable.}
        QTextFrame* {.header:headerFile,importcpp:"QTextFrame" ,pure.} = object of QTextObject
        QTextBlockUserData* {.header:headerFile,importcpp:"QTextBlockUserData" ,pure.} = object {.inheritable.}
        QTextBlock* {.header:headerFile,importcpp:"QTextBlock" ,pure.} = object {.inheritable.}
        QTextFragment* {.header:headerFile,importcpp:"QTextFragment" ,pure.} = object {.inheritable.}
