...
when (NimMajor, NimMinor, NimPatch) < (1, 9, 0):
    ...
    type
        ...
        QItemSelectionRange* {.header:headerFile,importcpp:"QItemSelectionRange" ,pure.} = object {.inheritable.}
        QItemSelectionModel* {.header:headerFile,importcpp:"QItemSelectionModel" ,pure.} = object of QObject
        QItemSelection* {.header:headerFile,importcpp:"QItemSelection" ,pure.} = object {.inheritable.}
